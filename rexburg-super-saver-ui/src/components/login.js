...
function Login(props) {
  ...
  return (
    ...
    <Header/>
      <div className="div">
        <div className="div-2">
          <div className="div-3">Sign In</div>
          <div className="div-4 form" >
            <div className="div-5">
          ...
          <div className="div-14">
            <button onClick={handleLogIn} className="div-15">Login</button>
          </div>
          </div>
          <div className="div-16">
            <div className="div-17">Don’t have account?</div>
            <Link to='/register' className="div-18"> Register</Link>
          </div>
        </div>
        <Footer/>
      </div>
